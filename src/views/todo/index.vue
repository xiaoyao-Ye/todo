  ...
  <div class="flex flex-col p-4 h-[calc(100vh-40px-10px)]">
    ...
    <n-scrollbar class="flex-1 px-4 pt-4">
      <TransitionGroup name="list" tag="div">
        <Card v-for="todo in todoListFiltered" :key="todo.id" :todo="todo" />
      </TransitionGroup>
    </n-scrollbar>

    <div v-show="category !== 'done'" class="pt-4">
...
const { todoListFiltered, category, sortStatus, sortCategory } = storeToRefs(todoStore)
